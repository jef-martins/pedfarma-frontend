        ...
        return (
            <div className="container">
                ...
                <div key={this.state.respostas.id} className="mt-2 card text-white bg-dark mb-3">
                    <div className="card-header">Fornecedor Nº {this.state.respostas.id}</div>
                    <div className="card-body">
                        ...
                        <Link className="btn btn-info mr-2" to={`/fornecedor/atualizar/${this.state.respostas.id}`}>Atualizar</Link>
                        <Link className="btn btn-danger" to={`/fornecedor/excluir/${this.state.respostas.id}`}>Excluir</Link>
                    </div>
                </div>
            </div>
        );
