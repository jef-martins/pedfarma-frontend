...
import SalvarCliente from '../classesCliente/classeAtualizarCliente';
...
import apiCli from '../urls/apiCliente';
        ...
        return(
            <div className="container">
                <div className="mt-2 card text-white bg-dark mb-3">
                    <div className="card-header">Atualizar Cliente</div>
                    <div className="card-body">
                        {
                            this.state.st === 1 ?
                                <SalvarCliente id={this.props.match.params.id} cpf={this.state.cpf} nome={this.state.nome}
                                     email={this.state.email} endereco_id={this.state.endereco_id}/>
                            :
                            <div>
                                <input onChange={this.setNome} className="mb-3 form-control" value={this.state.nome} placeholder="Digite o Nome"/>
                                <input onChange={this.setCpf} className="mb-3 form-control" value={this.state.cpf} placeholder="Digite o CPF"/>
                                <input onChange={this.setEmail} className="mb-3 form-control" value={this.state.email} placeholder="Digite o E-mail"/>
                                Estado:
